...
public class ParserGen {
  ...
  private final FramePath parserPath;
  ...
  public String WriteParser() {
    ...
    fram = g.OpenFrame(this.parserPath);
    ...
    g.CopyFramePart("-->parseRoot"); gen.println("\t\t" + tab.grammarSymbol.name + "();"); if (tab.checkEOF) gen.println("\t\tExpect(0);");
    g.CopyFramePart("-->initialization"); InitSets();
    g.CopyFramePart("-->errors"); gen.print(err.toString());
    g.CopyFramePart(null);
    gen.close();
    buffer.setPos(oldPos);
    return g.textWriter.toString();
  }
  ...
  public ParserGen (Parser parser, FramePath parserPath) {
    tab = parser.tab;
